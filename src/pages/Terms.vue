  ...
  <Layout>
    <div class="container-inner mx-auto py-16">
         ...
         <br><p>
                  ...
                  to it, still belong to dfeverx.
                </p> <p>
                  dfeverx is committed to ensuring that the app is
                  ...
                  The Get My Exam app stores and processes personal data that
                  ...
                  that the Get My Exam app won’t work properly or at all.
                </p> <div><p>
                  ...
                  dfeverx will not take responsibility for. Certain
                  functions of the app will require the app to have an active
                  internet connection. The connection can be Wi-Fi, or provided
                  by your mobile network provider, but dfeverx
                  ...
                  Along the same lines, dfeverx cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service,
                  dfeverx cannot accept responsibility.
                </p> <p>
                  With respect to dfeverx’s responsibility for your
                  use of the app, when you’re using the app, it’s important to
                  bear in mind that although we endeavour to ensure that it is
                  updated and correct at all times, we do rely on third parties
                  to provide information to us so that we can make it available
                  to you. dfeverx accepts no liability for any
                  ...
                  using the app. dfeverx does not promise that it
